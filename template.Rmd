...
packages <- c("rmarkdown", "tinytex", "rnaturalearth", "rnaturalearthdata", "maps", "tidyverse")
...
library(tidyverse) library(tidyr) library(readr) library(ggplot2) library(rnaturalearth) library(maps) library(dplyr) library(purrr) library(stringr)
...
```{r visualize spatial, include=FALSE}
...
```{r visualization temporal, include=FALSE}
...
```{r visualization subgroup, include=FALSE}
...
```{r visualization event, include=FALSE}
