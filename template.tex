...
\begin{figure}
\includegraphics[width=0.8\linewidth]{template_files/figure-latex/visualize spatial-1} \end{figure}

\pandocbounded{\includegraphics[keepaspectratio]{template_files/figure-latex/alaska-1.pdf}}
...
Texas emerged as a notable outlier in our spatial variation analysis,
prompting us to conduct a more comprehensive temporal examination of the
state's uninsured population dynamics. Consequently, we analyzed Texas's
proportion of uninsured residents across a thirteen-year period from
2010 to 2023, excluding 2020 data due to potential pandemic-related
anomalies. Furthermore, we sought to investigate whether economic growth
served as a contributing factor in explaining the observed patterns in
insurance coverage rates throughout this time frame.
